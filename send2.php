...
<head>
    ...
    <script type="text/javascript">
        function submitChk() {
            return window.confirm('2問目の回答です。回答してよろしいですか？回答を間違えると修正する術がありません。注意してください。');
        }
    </script>
</head>
        ...
        <div class="tabs">
            ...
            <div class="tab_content" id="programming_content">
                <div class="tab_content_description">
                    <form action="php/reload.php" method="post" class="reload">
                        <input type="hidden" name="formID" value="send2">
            ...
            <div class="tab_content" id="design_content">
                <div class="tab_content_description">
                    ...
                    <form action="php/do_send_answer.php" method="post" class="answer2" onsubmit="return submitChk()">
                        <div class="radio">
                            <input type="radio" name="answer2" id="A" value="A" checked>
                            <label for="A" class="A">A</label>
                        </div>
                        <div class="radio">
                            <input type="radio" name="answer2" id="B" value="B">
                            <label for="B" class="B">B</label>
                        </div>
                        <div class="radio">
                            <input type="radio" name="answer2" id="C" value="C">
                            <label for="C" class="C">C</label>
                        </div>
                        <div class="radio">
                            <input type="radio" name="answer2" id="D" value="D">
                            <label for="D" class="D">D</label>
                        </div><br>
                        <input type="hidden" name="sendName" value="send2">
                        <input type="hidden" name="answerName" value="answer2">
