...
<head>
    ...
    <script type="text/javascript">
        function submitChk() {
            return window.confirm('アンケートを投稿します。よろしいですか？');
        }
    </script>
</head>
...
<body>
    <center>
        ...
        <div class="tabs">
            ...
            <label class="tab_item" for="design"><i class="fas fa-forward"></i> 最後に</label>

            <div class="tab_content" id="programming_content">
                <div class="tab_content_description">
                    <form action="php/reload.php" method="post" class="reload">
                        <input type="hidden" name="formID" value="result3">
            ...
            <div class="tab_content" id="design_content">
                <div class="tab_content_description">
                    <p>忘年会に対するアンケートを募集しています。</p>
                    <p>こういう忘年会にしたい。</p>
                    <p>こんな点がいまいちだった。など、</p>
                    <p>忌憚のないご意見を頂ければと思います！</p>
                    <form action="php/do_questionnaire.php" method="post" class="reload" onsubmit="return submitChk()">
                        <textarea name="contents" cols="40" rows="5"></textarea></p>
                        <input type="submit" class="submit" value=" 投稿 ">
                    </form>
                    <br>
                    <p>Qiita(技術系情報共有サイト)に<br>本アプリの作成経緯を<br>記事にしています。</p>
                    <a href="./result3.php">飲み会の余興支援Webアプリを<br>作成してみた。</a>
                    <br><br>
                    <p>ソースコードも<br>GitHubで公開しています。<br></p>
                    <a href='https://github.com/naninanya'>クイズアプリ</a>
                </div>
            </div>
        </div>
    </center>
