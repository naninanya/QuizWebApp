...
<head>
    ...
    <script type="text/javascript">
        function submitChk() {
            return window.confirm('1問目の回答です。回答してよろしいですか？回答を間違えると修正する術がありません。注意してください。');
        }
    </script>
</head>
        ...
        <div class="tabs">
            ...
            <div class="tab_content" id="programming_content">
                <div class="tab_content_description">
                    <form action="php/reload.php" method="post" class="reload">
                        <input type="hidden" name="formID" value="send1">
            ...
            <div class="tab_content" id="design_content">
                <div class="tab_content_description">
                    ...
                    <form action="php/do_send_answer.php" method="post" class="answer1" onsubmit="return submitChk()">
                        <div class="radio">
                        ...
                        <input type="hidden" name="sendName" value="send1">
