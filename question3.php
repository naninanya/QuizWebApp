        ...
        <div class="tabs">
            ...
            <div class="tab_content" id="programming_content">
                <div class="tab_content_description">
                    <form action="php/reload.php" method="post" class="reload">
                        <input type="hidden" name="formID" value="question3">
            ...
            <div class="tab_content" id="all_content">
                <div class="tab_content_description">
                    ...
                    <form action="php/do_answer.php" method="post" class="answer3" onsubmit="return submitChk()">
                        <div class="radio">
                        ...
                        <div class="radio">
                            <input type="radio" name="answer3" id="x" value="x">
                        ...
                        <input type="hidden" name="questionName" value="question3">
                        <?php
                        if ($point > 0)
