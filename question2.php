        ...
        <div class="tabs">
            ...
            <div class="tab_content" id="all_content">
                <div class="tab_content_description">
                    ...
                    <form action="php/do_answer.php" method="post" class="answer2" onsubmit="return submitChk()">
                        <div class="radio">
                        ...
                        <div class="radio">
                            <input type="radio" name="answer2" id="x" value="x">
                        ...
                        <input type="hidden" name="questionName" value="question2">
                        <?php
                        if ($point > 0)
